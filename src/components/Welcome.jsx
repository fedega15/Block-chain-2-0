...
const commonStyles ="min-h-[65px] sm:px-0 px-4 sm:min-w-[110px] flex justify-center items-center border-[0.5px] border-gray-400 text-white"
    ...
    return (
            ...
            <div className="flex mf:flex-row items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-col flex-1 justify-start  mf:mr-10">
                    ...
                    <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
                        Explore the crypto world. Buy and sell cryptocourrencies on Krypto.
                    </p>
                    <button
                        type="button"
                ...
                <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
                        <div className="p-5 justify-end items-start flex-col rounded-xl h-40  sm:w-72 w-full my-5 eth-card white-glassmorpism">
                            <div className="flex justify-between flex-col w-full h-full h-hull">
        ...
        <br />
                        <div className="p-7 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism ">
                            ...
                            <Input placeholder="Amounth  (ETH)" name="amount" type="text" handleChange={() => {}} />
